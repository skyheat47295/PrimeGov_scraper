...
local_path = './test.data'  # Path to local files to be uploaded.
...
folder = drive.ListFile({'q': f"title = '{g_path}' and trashed=false"}).GetList()[0]  # get the folder we just created
